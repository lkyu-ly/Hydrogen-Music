...
<template>
  <div class="classify-list">
    <div class="list-item" :class="{'list-item-selected': router.currentRoute.value.params.id == item.id}" @click="showFiles(item)" v-for="(item, index) in props.classifyData" :key="index">
        <div class="item-img">
