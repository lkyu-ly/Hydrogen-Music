  ...
  <div class="local-music-list">
    <div class="list-container">
      <div class="list-folder" v-show="listType1 == 3 && listType2 == 0 || listType1 == 2 && listType2 == 1">
        <div class="list-item" @click.stop="showFiles(item)" :class="{'list-item-open': item.show && item.children.length != 0, 'list-item-selected': router.currentRoute.value.query.name == item.name}" v-for="(item, index) in props.folderlist" :key="index">
          <div class="folder">
